            ...
            braintreeClient.getConfiguration { _: Configuration?, _: Exception? ->
                val venmoRequest = VenmoRequest(getPaymentMethodUsage()).apply {
                    ...
                    if (amount?.value == "only_amount") {
                        ...
                        lineItems.add(VenmoLineItem(VenmoLineItemKind.DEBIT, "Item 1", 1, "2"))
                        lineItems.add(VenmoLineItem(VenmoLineItemKind.DEBIT, "Item 2", 2, "5"))
                        lineItems.add(VenmoLineItem(VenmoLineItemKind.CREDIT, "Discount", 1, "2"))
                        subTotalAmount = "10"
                        taxAmount = "0.5"
                        shippingAmount = "0.5"
                        discountAmount = "1"
